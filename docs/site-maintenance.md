...
The approved workflow publishes a preview first, checks it, then promotes it to production. Repository connection and deployed addresses are recorded in the verification report when confirmed.
